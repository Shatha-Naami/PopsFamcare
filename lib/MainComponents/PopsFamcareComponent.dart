                  ...
                  children: [
                    ((widget.showImage == true) &&
                        ...
                        : ((widget.showImage == false) &&
                                (widget.showSuccess == true))
                            ? CheckComponent()
                            : Container(),
                    MessagesComponents(
                        title: !widget.showSuccess
                            ? 'تأكيد الإلغاء'
                            : 'تم حجز الجلسة بنجاح',
                        fontWeight: FontWeight.w800,
                        fontSize: 20,
                        width: widthScreen,
                        margin: !widget.showSuccess
                        ...
                        children: [
                          ...
                          if (widget.showBackButton || widget.showSuccess)
                            ButtonComponent(
                              ...
                              background: Color(0xffF4F5F8),
                              size: 20,
                              onTapped: () { Navigator.pop(context);print('back');}
                            ),
                          Divider(height: 1, thickness: 0.8),
                          if (!widget.showSuccess)
                            ButtonComponent(
                              ...
                              size: 18,
                              onTapped: () { Navigator.pop(context);print('cancel');},
                            ),
                          Divider(height: 1, thickness: 0.8),
                        ],
                      ),
